...
void to_json(nlohmann::json& json, const TaskSnapshot& task) {
    json = {
        ...
        {"verifiedBytes", task.verified_bytes},
...
bool can_transition(TaskState from, TaskState to) {
    ...
    case TaskState::checking: return to == TaskState::queued || to == TaskState::downloading || to == TaskState::completed;
    case TaskState::queued: return to == TaskState::metadata || to == TaskState::checking || to == TaskState::downloading;
    case TaskState::downloading: return to == TaskState::checking || to == TaskState::completed;
    case TaskState::paused: return to == TaskState::metadata || to == TaskState::checking || to == TaskState::queued || to == TaskState::downloading;
