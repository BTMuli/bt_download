...
file(WRITE "${input_path}"
    "{\"jsonrpc\":\"2.0\",\"id\":\"init\",\"method\":\"engine.initialize\",\"params\":{\"protocolVersion\":\"1.5\",\"statePath\":\"${json_state_path}\"}}\n"
...
if(NOT protocol_output MATCHES "\"protocolVersion\":\"1.5\"")
    message(FATAL_ERROR "protocol 1.5 was not advertised: ${protocol_output}")
endif()
