...
file(WRITE "${input_path}"
    "{\"jsonrpc\":\"2.0\",\"id\":\"init\",\"method\":\"engine.initialize\",\"params\":{\"protocolVersion\":\"1.2\",\"statePath\":\"${json_state_path}\"}}\n"
...
if(NOT protocol_output MATCHES "\"protocolVersion\":\"1.2\"")
    message(FATAL_ERROR "protocol 1.2 was not advertised: ${protocol_output}")
endif()
